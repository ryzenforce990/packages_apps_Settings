...
public class HorizonVersionDetailPreferenceController extends BasePreferenceController {
    ...
    private static final String KEY_HORIZON_BUILD_VERSION_PROP = "ro.horizon.build_version";
    private static final String KEY_HORIZON_DEVICE_PROP = "ro.horizon.device";
    private static final String KEY_HORIZON_BUILD_TYPE_PROP = "ro.horizon.build_type";
    private static final String KEY_HORIZON_RELEASE_VERSION_PROP = "ro.horizon.version";
    ...
    public HorizonVersionDetailPreferenceController(Context context, String key) {
        super(context, key);
    ...
    public boolean handlePreferenceTreeClick(Preference preference) {
        ...
        if (fullRomVersion) {
            ...
            preference.setSummary(SystemProperties.get(KEY_HORIZON_RELEASE_VERSION_PROP,
    ...
    private String shortRomVersion() {
        String romVersion = SystemProperties.get(KEY_HORIZON_BUILD_VERSION_PROP,
                this.mContext.getString(R.string.device_info_default));
        String horizonCodename = SystemProperties.get(KEY_HORIZON_CODENAME_PROP,
                this.mContext.getString(R.string.device_info_default));
        String deviceCodename = SystemProperties.get(KEY_HORIZON_DEVICE_PROP,
                this.mContext.getString(R.string.device_info_default));
        String romReleasetype = SystemProperties.get(KEY_HORIZON_BUILD_TYPE_PROP,
                this.mContext.getString(R.string.device_info_default));
        String shortVersion = romVersion + " | " + horizonCodename + " | " + deviceCodename + " | " + romReleasetype;
        return shortVersion;
    }
